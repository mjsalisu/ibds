...
$sql = "SELECT id, name, regno, gender, level, cgpa, state, disability FROM `students` WHERE disability!='Healthy' AND status='Approved' ORDER BY `cgpa` DESC, `name` ASC;";
    ...
    <div class="card-body">
        ...
        <div class="card">  
            <div class="table-responsive-sm p-4">
                ...
                <?php
                    if ($num <= 0) {
                      echo "<tr><td colspan='9' class='text-center text-muted py-2 h5'>
